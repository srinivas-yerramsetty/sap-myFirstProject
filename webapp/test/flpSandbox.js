		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Button App",
									"targetURL": "#nsButtonfirstproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsButtonfirstproject-display": {
								"semanticObject": "nsButtonfirstproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.Button.firstproject",
									"url": sap.ui.require.toUrl("ns/Button/firstproject")
								}
							}
						}
					}
